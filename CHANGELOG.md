...
## [0.21.0](https://github.com/Nicceboy/rasn/compare/rasn-v0.20.2...rasn-v0.21.0) - 2024-11-04
...
- split iai and criterion benches, use correct adapters ([#366](https://github.com/Nicceboy/rasn/pull/366))
- cleanup some unnecessary dependencies ([#362](https://github.com/Nicceboy/rasn/pull/362))
- remove version pin from release-plz ([#356](https://github.com/Nicceboy/rasn/pull/356))
...
- Update README.md
- Update README.md
- Remove dependency on rayon ([#363](https://github.com/Nicceboy/rasn/pull/363))
- Extract proc macro into own crate ([#364](https://github.com/Nicceboy/rasn/pull/364))
- Update base_benchmarks.yml
- Attempt to fix base benchmarks on CI ([#365](https://github.com/Nicceboy/rasn/pull/365))
- Update base_benchmarks.yml
- Update base_benchmarks.yml
- Create base_benchmarks.yml
- Update from iai to iai-callgrind ([#358](https://github.com/Nicceboy/rasn/pull/358))
- black box integer test, use macros ([#360](https://github.com/Nicceboy/rasn/pull/360))
