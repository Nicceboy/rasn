...
## [0.22.1](https://github.com/Nicceboy/rasn/compare/rasn-v0.22.0...rasn-v0.22.1) - 2024-11-29

### Fixed

- FixedBitString might work as expected ([#385](https://github.com/Nicceboy/rasn/pull/385))

### Other

- oer: format! in error messages has too much impact ([#387](https://github.com/Nicceboy/rasn/pull/387))
- Add `decode_with_remainder` for decoding stream ([#386](https://github.com/Nicceboy/rasn/pull/386))
